<template>
    ...
    <div class="h-full w-full fixed top-0 left-0 flex items-center justify-center">
        <div class=" bg-white md:w-1/3 w-72 rounded-xl  shadow-xl border">
            <div class="w-full bg-gray-50 text-gray-700 rounded-xl p-5 flex items-center justify-between">
                <h3 class="text-xl">ساخت کاربر جدید</h3>
            ...
            <div class="w-full p-5">
                <div v-if="errors.name || errors.user_name || errors.password" class="mb-5 bg-red-100 border border-red-500 p-5 rounded-xl">
                    <ul class="flex flex-col gap-5 text-red-500 text-sm">
                        <li>لطفا نام کاربر را وارد کنید</li>
                    </ul>
                </div>
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="w-full">
                            <div class="flex-1 flex dark">
                                ...
                                <input v-model="user.name" type="text" class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 duration-150" placeholder="نام">
                            </div>
                        </div>
                        <div class="w-full">
